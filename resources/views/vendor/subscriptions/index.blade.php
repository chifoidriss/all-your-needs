...
<div class="container-md">
    <div class="row">
        ...
        <div class="d-flex justify-content-center col-md-12">
          <a href="https://api.whatsapp.com/send?phone=+237691247618&text= Bonjour AllYourNeeds j'aimerais effectuer une subscription du type : ">
            <button class="btn btn-success">@awt('Make a Subscription')</button>
          </a>
        </div>
        <div class="text-center mt-4">
                <h3 class="font-weight-bold">Read this carefully before making a subscription</h3>
        </div>
</div>

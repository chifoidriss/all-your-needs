...
@section('button_create')
  <center><h3 >List's Theme</h3></center>
 
   <div class="col mb-6">
       <a href="{{url('create_theme')}}"> <button type="button" class="mb-2 btn btn-primary mr-2">Create Theme</button></a >
    </div>
@endsection
@section('table')
<div class="row">
                        ...
                        <tr>
                          ...
                          <td>
                            <form  action="{{url('deletetheme',$collec->id)}}" method="post">
                               @csrf
                                @method('DELETE')
                              <a href="{{url('edit_theme',$collec->id)}}"><button type="button" class="mb-2 btn btn-success mr-2">Edit</button></a>

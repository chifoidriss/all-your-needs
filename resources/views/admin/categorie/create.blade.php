         ...
         <div class="col-sm-12 col-md-12 pl-5 pr-5">
            ...
            <form action="{{route('admin.categorie.store')}}" method="post">
               ...
               <div class="form-group">
                  <input type="text" id='name' class="form-control @error('name') is-invalid @enderror" placeholder="Name" name="name" value="{{ old('name') }}"> 
                  @error('name')
               ...
               <div class="form-group">
                  <select class="form-control @error('super_category_id') is-invalid @enderror" id='super_category_id' name="super_category_id" > 
                     <option value="">
